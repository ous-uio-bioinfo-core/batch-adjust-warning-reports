...
We were later informed, that this was not the version of the data used as a starting point in Towfic et al. The data actually used in Towfic et al. is found in GEO deposit with accession GSE61901. We were also given the scripts used to preprocess the data in Towfic et al (personal communication, Ben Zeskind). There were some important deviations between our reproduction and Towfic et al.´s analysis, mainly that the data table from GSE61901 has two columns per sample, each originating from the same hybridization, but from two separate strips consisting of the same probes. This is the top of the table:
