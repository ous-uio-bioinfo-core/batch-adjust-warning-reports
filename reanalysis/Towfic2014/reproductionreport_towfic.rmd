...
Shuffling the N and DP labels with in batches produces about the same p-value distribution as for the real data. This is an indication that the significant genes found in the real data is not associated with the N and DP labels, but a rather an adverseffect of the ComBat adjustments.
